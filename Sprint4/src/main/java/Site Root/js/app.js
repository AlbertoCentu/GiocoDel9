var APP = {
    ...
    callBack_save: function (event)
    {
        $.ajax({
            url: "/Sprint4/Salva.htm",
            method: "GET",
            contentType: "application/json; charset=utf-8",
            accepts: {json: "application/json, text/javascript"},
            data: jsPar = APP.ls_inizio
        });
    },

    callBack_reset: function (event)
    {
        $.ajax({
            url: "/Sprint4/Ripristina.htm",
            method: "GET",
            contentType: "application/json; charset=utf-8",
            accepts: {json: "application/json, text/javascript"}
        });
    ...
    callBack_load: function (event)
    {
        for (var i = 0; i < 9; i++) {
            APP.ls_inizio[i] = APP.ls_salvataggio[i];
        }
        APP.printer();
    },
    ...
    init_callBack_save_Click: function () {
        $("#save").on('click', APP.callBack_save);
    },

    init_callBack_reset_Click: function () {
        $("#reset").on('click', APP.callBack_reset);
    },
